...
namespace ObjParser.Types
{
    public class Face : IType
    {
        ...
        public Face(int[] vInds, int[] nInds, int[] tInds) {
            VertexIndexList = vInds;
            NormalIndexList = nInds;
            TextureVertexIndexList = tInds;
        }
            ...
            for (int i = 0; i < vcount; i++)
            {
                ...
                if (parts.Count() > 1)
                {
                    ...
                    if (success) {
                        ...
                        NormalIndexList[i] = vindex;    // TODO: Possibly an error
                    }
                }
            }
        }
        ...
        public override string ToString()
        {
            ...
            {
                //if (i < TextureVertexIndexList.Length && i < NormalIndexList.Length)
                //{
                //    b.AppendFormat(" {0}/{1}/{2}", VertexIndexList[i], TextureVertexIndexList[i], NormalIndexList[i]);
                //}
